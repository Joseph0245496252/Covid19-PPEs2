            ...
            <div className="grid-container">
              <main>
                  ...
                  <div className="container">
                    <div className="row py-4 d-flex align-items-center">
                      <div className="col-md-12 text-center">
                        <Link href="https://web.facebook.com/asante.joseph.90">
                          <i className="fab fa-facebook-f text-white mr-4"></i>
                        </Link>
                        <Link href="https://twitter.com/ReppyAsante">
                          <i className="fab fa-twitter text-white mr-4"></i>
                        </Link>
                        <Link href="#">
                          <i className="fab fa-google-plus-g text-white mr-4"></i>
                        </Link>
                        <Link href="https://www.linkedin.com/in/joseph-asante-868799199/">
                    ...
                    <div className="row footerRow">
                      ...
                      <h6 className="text-uppercase font-weight-bold">
                        ...
                        <ul className="list-unstyled">
                          <li className="my-2">
                            <Link href="#">Covid 19 Product</Link>
                          </li>
                          <li className="my-2">
                      ...
                      <div className="col-md-3 mx-auto mb-4">
                        ...
                        <ul className="list-unstyled">
                          <li className="my-2">
                            <Link href="#">High Visibility Waistcoat Vest</Link>
                          </li>
                          <li className="my-2">
                            <Link href="#">Infrared Forehead Thermometer</Link>
                          </li>
                          <li className="my-2">
                            <Link href="#">Automatic Hand Sanitiser</Link>
                          </li>
                          <li className="my-2">
                            <Link href="#">Face Masks With T-shirt</Link>
                          </li>
                          <li className="my-2">
                            <Link href="#">Reusable Face Shields</Link>
                          </li>
                        </ul>
                      </div>
                      ...
                      <div className="col-md-2 mx-auto mb-4 contactDiv">
                        ...
                        <ul className="list-unstyled">
                          <li className="my-2">
                            <i className="fas fa-home mr-3"></i>Accra Digital
                            Center
                          </li>
                          <li className="my-2">
                            <i className="far fa-envelope mr-3"></i>
                            freecoding1@gmail.com
                          </li>
                          <li className="my-2">
                            <i className="fas fa-phone mr-3"></i>+233245496252
                          </li>
                          <li className="my-2">
                            <i className="fas fa-print mr-3"></i>+233245696997
                          </li>
                        </ul>
                      </div>
                    </div>
                ...
                <div className="footer-copyright text-center py-3 copyright">
                  <p>
                    &copy; Copyright <Link href="#">project@codetrain.com</Link>
                  </p>
